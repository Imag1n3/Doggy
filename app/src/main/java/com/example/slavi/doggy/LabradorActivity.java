...
public class LabradorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(LabradorActivity.this, HomeActivity.class);
        ...
        btn_orderBy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(LabradorActivity.this)
                        .setTitle("Order by")
                        .setAdapter(adapter, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                switch (which) {
                                    case 0:
                                        gridView = (GridView) findViewById(R.id.grdv_labrador);
                                        gridViewAdapter = new GridViewAdapter(LabradorActivity.this, mostPopular);
                                    ...
                                    case 1:
                                        gridView = (GridView) findViewById(R.id.grdv_labrador);
                                        gridViewAdapter = new GridViewAdapter(LabradorActivity.this, mostRecent);
    ...
    private class DownloadImages extends AsyncTask<String, Integer, Bitmap> {
        ...
        protected Bitmap doInBackground(String... params) {
            ...
            //First query (gets 20 photos with tag labrador)
            ...
            //Second query (gets 20 photos with tag labrador)
            Map<String, Long> options2 = new HashMap<>();
            options2.put("limit", 20l);
            options2.put("before", timeStamp);

            for (Post post : client.tagged("labrador", options2)) {
                if (post instanceof PhotoPost) {
                    photoPost = (PhotoPost) post;
                    for (Photo photo : photoPost.getPhotos()) {
            ...
            //Third query (gets 10 photos with tag labrador)
            Map<String, Long> options3 = new HashMap<>();
            options3.put("limit", 20l);
            options3.put("before", timeStamp);

            for (Post post : client.tagged("labrador", options3)) {
                if (post instanceof PhotoPost) {
                    photoPost = (PhotoPost) post;
                    for (Photo photo : photoPost.getPhotos()) {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dl = ProgressDialog.show(LabradorActivity.this, "Downloading photos...", "");
        }
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            gridView.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent intent = new Intent(LabradorActivity.this, ViewImageLabActivity.class);
