...
public class CockerspanielActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cockerspaniel);
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CockerspanielActivity.this, HomeActivity.class);
        ...
        btn_orderBy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(CockerspanielActivity.this)
                        .setTitle("Order by")
                        .setAdapter(adapter, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                switch (which) {
                                    case 0:
                                        gridView = (GridView) findViewById(R.id.grdv_cockerspaniel);
                                        gridViewAdapter = new GridViewAdapter(CockerspanielActivity.this, mostPopular);
                                    ...
                                    case 1:
                                        gridView = (GridView) findViewById(R.id.grdv_cockerspaniel);
                                        gridViewAdapter = new GridViewAdapter(CockerspanielActivity.this, mostRecent);
    ...
    //Async task which downloads most recent photos for tag cockerspaniel
    private class DownloadImages extends AsyncTask<String, Integer, Bitmap> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dl = ProgressDialog.show(CockerspanielActivity.this, "Downloading photos...", "");
        }
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent intent = new Intent(CockerspanielActivity.this, ViewImageSpanActivity.class);
